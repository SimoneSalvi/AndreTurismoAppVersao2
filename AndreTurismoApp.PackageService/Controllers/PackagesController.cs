    ...
    public class PackagesController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<Package>>> GetPackage()
        {
          if (_context.Package == null)
          {
              return NotFound();
                   ...
                   await _context.Package.Include(a => a.Ticket.Origin.City).ToListAsync();
            return await _context.Package.Include(a => a.Ticket.Destination.City).ToListAsync();
        }
        ...
        public async Task<ActionResult<Package>> GetPackage(int id)
        {
          if (_context.Package == null)
          {
            ...
            var package = await _context.Package.Include(a => a.Ticket.Origin.City).FirstOrDefaultAsync();
                package = await _context.Package.Include(a => a.Ticket.Destination.City).FirstOrDefaultAsync();
